  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          filled: true,
          fillColor: fillColor,
          hintStyle: genericTextStyle(color: Colors.black, fontSize: fontSize),
          counterText: counterText ?? '*',
          counterStyle: genericTextStyle(color: counterText != null ? Colors.black45 : Colors.transparent, fontSize: fontSize*0.9),
